...
export default function TodayMenu({
	...
	const items: MenuItem[] = [
		{ icon: "coffee", label: "Breakfast", value: breakfast, time: "6–10 AM" },
		{ icon: "sun-o", label: "Lunch", value: lunch, time: "1–3 PM" },
		{ icon: "moon-o", label: "Dinner", value: dinner, time: "8–10 PM" },
	];
